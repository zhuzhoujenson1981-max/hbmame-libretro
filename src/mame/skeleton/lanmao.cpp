...
static INPUT_PORTS_START( panda3 ) 
    ...
    PORT_DIPNAME( 0x20, 0x20, "Coin" )  PORT_DIPLOCATION("DSW:6")
	PORT_DIPSETTING(    0x00, "1" ) 
	PORT_DIPSETTING(    0x20, "10" )
	PORT_DIPNAME( 0xC0, 0xC0, "Minimum Bet" )  PORT_DIPLOCATION("DSW:7,8")
...
static INPUT_PORTS_START( panda4 ) 
	...
	PORT_DIPUNKNOWN_DIPLOC( 0x04, 0x04, "DSW:3")
	PORT_DIPUNKNOWN_DIPLOC( 0x08, 0x08, "DSW:4")
	PORT_DIPNAME( 0x30, 0x20, "Coin" )  PORT_DIPLOCATION("DSW:5,6")
...
static INPUT_PORTS_START( baowang ) 
	...
	PORT_DIPNAME( 0x08, 0x00, "Coin" ) PORT_DIPLOCATION("DSW:4")
...
void panda2_state::panda2(machine_config &config)
{
	...
	i8279_device &kdc(I8279(config, "kdc", 10.738635_MHz_XTAL / 2 )); // TODO: divider
...
ROM_START( panda2 )
	...
	ROM_LOAD( "w78e065", 0x0000, 0x8000, CRC(AE7FB308) SHA1(51EBCFED11D2A20691ED32A3739BC0B822935610) )

	ROM_REGION( 0x800, "at28c16", 0 )
	ROM_LOAD( "at28c16.u9", 0x000, 0x800, CRC(AD57603E) SHA1(AC38AC898C06AA45DFA81119F0F16662CDD15A39) )
	
	ROM_REGION( 0x800, "nvram", 0 )
	ROM_LOAD( "nvram", 0x000, 0x800, CRC(DA409087) SHA1(44B9286E87BA26DA024BCE7F00F44936E9764102) ) // pre-initialized
ROM_END
ROM_START( panda3 )
	...
	ROM_REGION( 0x800, "nvram", 0 )
	ROM_LOAD( "nvram", 0x000, 0x800, CRC(99BAC276) SHA1(CD91C21E9E1FB420A18CADB31DBBD41080CE9BC9) )
...
ROM_START( panda3clr)
	...
	ROM_REGION( 0x800, "nvram", 0 )
	ROM_LOAD( "nvram", 0x000, 0x800, CRC(4AF261EE) SHA1(CECE6D5B65BA0375E7889F239DA0D05DBE3722DB) )
...
ROM_START( panda4 )
	...
	ROM_REGION( 0x800, "nvram", 0 )
	ROM_LOAD( "nvram", 0x000, 0x800, CRC(57E2748D) SHA1(11B098343D2EFB9665D613E710A1A4E9BE8F721A) )
...
ROM_START( baowang )
	...
	ROM_REGION( 0x800, "nvram", 0 )
	ROM_LOAD( "nvram", 0x000, 0x800, CRC(F28FF1FA) SHA1(111F76E2CE1DEAE3EFE04187B130A6334488CB09) )
	ROM_END
...
ROM_START( msaiche ) // 玛莉赛车 (Mǎlì Sàichē - Mario Racing)
	ROM_REGION( 0x8000, "maincpu", 0 )
	ROM_LOAD( "w78e065", 0x0000, 0x8000, CRC(F0064326) SHA1(C044FDDF779C733B15CD2326EF26057A165F0882) )

	ROM_REGION( 0x800, "at28c16", 0 )
	ROM_LOAD( "at28c16.u9", 0x000, 0x800, CRC(BD67AF27) SHA1(19D19BF00FBE8573E13FB6026DB31889023D4194) ) // same as panda2?

	ROM_REGION( 0x800, "nvram", 0 )
	ROM_LOAD( "nvram", 0x000, 0x800, CRC(0B6A338C) SHA1(67D70D0A582E484B4076806C3E524F2D33C8BFD7) ) // pre-initialized
ROM_END
